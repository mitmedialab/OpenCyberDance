...
const typeMap: any = {
    ...
    "Material": o([
        ...
        { json: "name", js: "name", typ: "" },
        { json: "pbrMetallicRoughness", js: "pbrMetallicRoughness", typ: r("PbrMetallicRoughness") },
    ], false),
    "Extensions": o([
        { json: "KHR_materials_specular", js: "KHR_materials_specular", typ: r("KHRMaterialsSpecular") },
        { json: "KHR_materials_ior", js: "KHR_materials_ior", typ: r("KHRMaterialsIor") },
    ], false),
    "KHRMaterialsIor": o([
        { json: "ior", js: "ior", typ: 3.14 },
    ], false),
